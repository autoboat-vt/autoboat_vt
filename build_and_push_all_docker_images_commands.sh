...
docker buildx build -t vtautoboat/autoboat_docker_dev_image:latest --platform linux/amd64 -f .devcontainer/Dockerfile .
docker buildx build -t vtautoboat/autoboat_docker_dev_image:microros --platform linux/amd64 -f .devcontainer/devcontainer_variants/Dockerfile.microros .
docker buildx build -t vtautoboat/autoboat_docker_dev_image:deepstream --platform linux/amd64 -f .devcontainer/devcontainer_variants/Dockerfile.deepstream .
docker buildx build -t vtautoboat/autoboat_docker_dev_image:yolo --platform linux/amd64 -f .devcontainer/devcontainer_variants/Dockerfile.yolo .
docker buildx build -t vtautoboat/autoboat_docker_dev_image:deepstream_and_yolo --platform linux/amd64 -f .devcontainer/devcontainer_variants/Dockerfile.deepstream_and_yolo .
