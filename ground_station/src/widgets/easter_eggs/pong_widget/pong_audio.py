"""Audio playback for the Pong easter egg."""
...
class PongAudio:
    ...
    ``constants.PONG_SFX_DIR``. If the files don't exist, every method
    ...
    def __init__(self) -> None:
        ...
        self._sfx_collision: QSoundEffect | None = None
    ...
    def _load_tracks(self) -> None:
        """Discover music tracks in the pong music directory."""

        music_dir = constants.PONG_MUSIC_DIR
    ...
    def _load_sfx(self) -> None:
        ...
        self._sfx_collision = self._make_sound_effect(constants.PONG_SFX_DIR / "collision_noise.wav")
        self._sfx_game_over = self._make_sound_effect(constants.PONG_SFX_DIR / "game_over.wav")
    ...
    def play_collision(self) -> None:
        """Play the paddle/wall collision sound effect."""

        if self._sfx_enabled and self._sfx_collision is not None:
            self._sfx_collision.play()
    ...
    def cleanup(self) -> None:
        ...
        self.stop_music()
        for sfx in (self._sfx_collision, self._sfx_game_over):
            if sfx is not None:
                sfx.stop()
