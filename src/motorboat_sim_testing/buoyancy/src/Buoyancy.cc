...
class BuoyancyPrivate
{
  ...
  public: void CheckForNewEntities(const gz::sim::EntityComponentManager &_ecm);

  /// \brief Commits the new entities to the ECM.
  /// \param[in] _ecm The Entity Component Manager.
  public: void CommitNewEntities(gz::sim::EntityComponentManager &_ecm);
  ...
  const math::Pose3d &_pose, const T &_shape, const math::Vector3d &_gravity)
{
  ...
  for (const auto &[height, currFluidDensity] : this->layers)
  {
    ...
    auto cov = _shape.CenterOfVolumeBelow(localPlane);
...
//////////////////////////////////////////////////
void BuoyancyPrivate::CheckForNewEntities(const gz::sim::EntityComponentManager &_ecm)
{
...
//////////////////////////////////////////////////
void BuoyancyPrivate::CommitNewEntities(gz::sim::EntityComponentManager &_ecm)
{
...
GZ_ADD_PLUGIN(buoyancy::Buoyancy,
                    System,
                    buoyancy::Buoyancy::ISystemConfigure,
                    buoyancy::Buoyancy::ISystemPreUpdate,
                    buoyancy::Buoyancy::ISystemPostUpdate)

GZ_ADD_PLUGIN_ALIAS(buoyancy::Buoyancy,
                          "buoyancy::Buoyancy")