...
public:
    MotorboatAutopilot(json autopilot_parameters) {

        rudder_pid_controller = DiscretePID(
            1/ autopilot_parameters["autopilot_refresh_rate"], 
            autopilot_parameters["heading_p_gain"], 
            autopilot_parameters["heading_i_gain"], 
            autopilot_parameters["heading_d_gain"], 
            autopilot_parameters["heading_n_gain"]
        );
