...
class MotorboatAutopilot:
    ...
    def __init__(self, autopilot_parameters: dict[str, Any], logger: RcutilsLogger) -> None:
        """
        Args:
        ...
        self.rudder_pid_controller = Discrete_PID(
            ...
            Kp=autopilot_parameters["heading_p_gain"],
            Ki=autopilot_parameters["heading_i_gain"],
            Kd=autopilot_parameters["heading_d_gain"],
            n=autopilot_parameters["heading_n_gain"],
        )
