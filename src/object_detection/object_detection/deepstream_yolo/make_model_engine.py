...
class EngineGenerator:
    ...
    def create_pipeline(self):
        ...
        caps_videotestsrc.set_property(
            "caps", Gst.Caps.from_string(f"video/x-raw, width={INPUT_WIDTH}, height={INPUT_HEIGHT}, framerate={FRAMERATE}")
        )
        ...
        caps_nvvidconv.set_property(
            "caps", Gst.Caps.from_string(f"video/x-raw(memory:NVMM), format=NV12, width={INPUT_WIDTH}, height={INPUT_HEIGHT}")
        )
