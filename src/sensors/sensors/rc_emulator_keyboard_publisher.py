...
def on_press(key):
    ...
    try:
        if key.char == "w":
            emulated_rcdata.joystick_left_y = 100.0
        elif key.char == "d":
            emulated_rcdata.joystick_left_x = 100.0
        elif key.char == "s":
            emulated_rcdata.joystick_left_y = -100.0
        elif key.char == "a":
            emulated_rcdata.joystick_left_x = -100.0
    ...
    try:
        if key == keyboard.Key.up:
            emulated_rcdata.joystick_right_y = 100.0
        elif key == keyboard.Key.right:
            emulated_rcdata.joystick_right_x = 100.0
...
def on_release(key):
    ...
    try:
        if key.char == "w":
            emulated_rcdata.joystick_left_y = 0.0
        elif key.char == "d":
            emulated_rcdata.joystick_left_x = 0.0
        elif key.char == "s":
            emulated_rcdata.joystick_left_y = 0.0
        elif key.char == "a":
            emulated_rcdata.joystick_left_x = 0.0
    ...
    try:
        if key == keyboard.Key.up:
            emulated_rcdata.joystick_right_y = 0.0
        elif key == keyboard.Key.right:
            emulated_rcdata.joystick_right_x = 0.0
        elif key == keyboard.Key.down:
            emulated_rcdata.joystick_right_y = 0.0
        elif key == keyboard.Key.left:
            emulated_rcdata.joystick_right_x = 0.0
