...
PATH_TO_ROS_PACKAGES_DIR = "/home/ws/ros_packages" if IS_DEV_CONTAINER else f"{os.path.expanduser('~')}/autoboat_vt/ros_packages"
...
YOLO_CONFIG = {
    11: f"{PATH_TO_ROS_PACKAGES_DIR}/object_detection/object_detection/deepstream_yolo/config_infer_primary_yolo11.txt",
    26: f"{PATH_TO_ROS_PACKAGES_DIR}/object_detection/object_detection/deepstream_yolo/config_infer_primary_yolo26.txt"
}
PATH_TO_PARAMETERS_FILE = f"{PATH_TO_ROS_PACKAGES_DIR}/object_detection/object_detection/cv_default_parameters.jsonc"
INFERENCE = True
...
# if SHOULD_SAVE_IMAGES and not os.path.exists(f"{PATH_TO_ROS_PACKAGES_DIR}/object_detection/object_detection/frame_results"):
#     os.makedirs(f"{PATH_TO_ROS_PACKAGES_DIR}/object_detection/object_detection/frame_results")
...
class ObjectDetection:
    def __init__(self, frame_number=-1, detector_confidence=0.0, tracker_confidence=0.0,
                 ...
                 class_id=-1, obj_label=None, pose_matrix=None, camera_matrix_inv=None) -> None:
...
class BuoyDetectionNode(Node):
    ...
    def _init_pipeline(self) -> None:
        ...
        if INFERENCE:
            ...
            preprocess.set_property('config-file', f'{PATH_TO_ROS_PACKAGES_DIR}/object_detection/object_detection/deepstream_yolo/preprocess_config.txt')
            ...
            tracker.set_property('ll-config-file', f'{PATH_TO_ROS_PACKAGES_DIR}/object_detection/object_detection/deepstream_yolo/config_tracker_NvDCF_perf.yml')
        ...
        # multifilesink.set_property('location', f"{PATH_TO_ROS_PACKAGES_DIR}/object_detection/object_detection/frame_results/frame%06d.jpg")
